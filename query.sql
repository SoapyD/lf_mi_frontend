...
[dbo].[NODE_REPORT_parameters] p
WHERE
ss.name = 'Support Requests - Heatmaps for Total Registered Tickets'
...
[dbo].[NODE_REPORT_parameters] p
WHERE
ss.name = 'Support Requests - Total Volume Flow Diagram'
...
r.name = 'Service Report'
AND s.name = 'Executive Summary'
AND sb.name IN ('Support Requests - Total Volume Flow Diagram')
...
r.name = 'Service Report'
AND s.name = 'Service Desk'
AND sb.name IN ('Support Requests - Heatmaps for Total Registered Tickets')
